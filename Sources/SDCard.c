...
int SDCard_Write_Single_Block(uint32_t sector, uint8_t buffer[])
{
    R1 r1;
    int i = 0;
...
int SDCard_Write_Mult_Blocks(uint32_t sector, uint8_t buffer[][SDCARD_SECTOR_SIZE], int block_cnt)
{
    R1 r1;
    int i = 0, j = 0;
